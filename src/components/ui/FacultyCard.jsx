...
export default function FacultyCard(name){
    ...
    return(
        <div onClick={() =>
            ...
            <Card>
                <CardContent className="p-5 flex flex-col space-y-3 hover:border-4">
                    ...
                    {
                        isExpanded && (
                            <span className="font-ebgaramond text-xs animate-accordion-down overflow-hidden">{name.description}</span>
                        )
                    }
                </CardContent>
            </Card>
