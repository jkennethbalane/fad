...
function App() {
  ...
  return (
    <>
      <Carousel className="w-full flex justify-center max-w-full xl:h-auto">
        <CarouselContent>
          <CarouselItem key="0" >
          <div>
            <Card className="border-black">
              <CardContent className="p-0 bg-cover flex items-left justify-left flex max-w-full w-full">
                <div className='relative'>
                  <video src={vid} autoPlay loop muted className='xl:h-full object-cover h-[48rem]'></video>
                  <div className='text-white py-3 xl:px-12 px-3 absolute left-0 bottom-0 flex flex-col space-y-1 font-ebgaramond font-[500] w-full'>
          ...
          <div>
            <Card className="border-black">
              <CardContent className="p-0 bg-cover flex items-left justify-left flex">
                <div className='relative'>
                  <img src={picture} className='xl:h-full object-cover h-[48rem]'></img>
                  <div className='text-white py-3 xl:px-12 px-3 absolute left-0 bottom-0 flex flex-col font-ebgaramond font-[500] w-full'>
          ...
          <div>
            <Card className="border-black">
              <CardContent className="p-0 bg-cover flex items-left justify-left flex">
                <div className='relative'>
                  <img src={eventimg} className='xl:h-full object-cover h-[48rem]'></img>
                  <div className='text-white py-3 xl:px-12 px-3 absolute left-0 bottom-0 flex flex-col font-ebgaramond font-[500] w-full'>
                    <span className='text-md xl:text-3xl'>FINE ARTS DEPARTMENT</span>
          ...
          <div>
            <Card className="border-black">
              <CardContent className="p-0 bg-cover flex items-left justify-left flex">
                <div className='relative'>
                  <img src={exhibitimg} className='xl:h-full object-cover h-[48rem]' ></img>
                  <div className='text-white py-3 xl:px-12 px-3 absolute left-0 bottom-0 flex flex-col font-ebgaramond font-[500] w-full'>
                    <span className='text-md xl:text-3xl'>FINE ARTS DEPARTMENT</span>
          ...
          <div>
            <Card className="border-black">
              <CardContent className="p-0 bg-cover flex items-left justify-left flex">
                <div className='relative'>
                  <img src={alumimg} className='xl:h-full object-cover h-[48rem] transform'></img>
                  <div className='text-white py-3 xl:px-12 px-3 absolute left-0 bottom-0 flex flex-col font-ebgaramond font-[500] w-full'>
                    <span className='text-md xl:text-3xl'>FINE ARTS DEPARTMENT</span>
