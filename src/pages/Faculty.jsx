                ...
                <div className='px-8 xl:px-12 py-6'>
                    ...
                    <div className='py-6'>
                        <div className='grid xl:grid-cols-3 grid-cols-1'>
                            <FacultyCard name='Ramon Talaga De La Cruz' position='Head, Fine Arts Department' index='1' picture={Fac1} description=" Ramon Talaga De La Cruz, current Head of the Fine Arts Department at the
                                ...
                                knowledge and experience to his leadership role in the fine arts field."/>
                        </div>
                        <div className='py-3'>
                            ...
                            <div className='grid xl:grid-cols-3 grid-cols-1'>
                                <FacultyCard name='Almina T. Tengco-Chan' position='Full-time Permanent' index='2' picture={Fac2} description="Almina T. Tengco-Chan is a former Dean of the College of Architecture and Fine
                                    ...
                                    "/>
                                <FacultyCard name='Ferdinand R. Doctolero' position='Full-time Permanent' index='3' picture={Fac3} description="Ferdinand R. Doctolero, an acclaimed Filipino visual artist and faculty member at
                                    ...
                                    "/>
                                <FacultyCard name='Wima Dollisen-Enriquez' position='Full-time Permanent' index='4' picture={Fac4} description=" Wima Dollisen-Enriquez, also known as Beck F. Dollisen, An artist who explores
                                    ...
                                    outlook in life. It shows in every single artwork that she creates."/>
                            </div>
                        </div>
                        ...
                        <div className='py-3'>
                            ...
                            <div className='grid xl:grid-cols-3 grid-cols-1'>
                                <FacultyCard name='Ernest Joseph Garcia' position='Full-time Temporary' index='5' picture={Fac5} description="Ernest Joseph Garcia is an Art director, graphic designer, academic, and a creative
                                    ...
                                    "/>
                                <FacultyCard name='Maria Regina D. Frejas' position='Full-time Temporary' index='6' picture={Fac6} description=""/>
                                <FacultyCard name='Majhalina I. Apuyan' position='Full-time Temporary' index='7' picture={Fac7} description="Majhalina I. Apuyan is a Graphic Artist and Designer passionate about traditional
                        ...
                        <div className='py-3'>
                            ...
                            <div className='grid xl:grid-cols-3 grid-cols-1'>
                                <FacultyCard name='Edward Simon' position='Part-time' index='8' picture={Fac8} description="ED simon is architecture photographer professional who specializes in capturing
                                ...
                                <FacultyCard name='Emmanuel Luis G. Borjal' position='Part-time' index='9' picture={Fac9} description=""/>
                                <FacultyCard name='Eric G. Guazon' position='Part-time' index='10' picture={Fac10} description="Eric Guazon, a visual artist, explores the themes of war, violence, and power in his
                                    ...
                                    "/>
                                <FacultyCard name='Jayne Pauline C. Masigan' position='Part-time' index='11' picture={Fac11} description="Jayne Pauline C. Masigan is a CumLaude graduate of the Technological University
                                    ...
                                    Degree at National Teachers College"/>
                                <FacultyCard name='Jerrica Sabariaga' position='Part-time' index='12' picture={Fac12} description=" Jerrica Sabariaga or better known as Mika Sabariaga, is a product of the
                                    ...
                                    "/>
                                <FacultyCard name='Jesa T. De Vera' position='Part-time' index='13' picture={Fac13} description="Jesa DeVera A Visual Designer for 14 years in IBM Business Services, a
                                    ...
                                    "/>
                                <FacultyCard name='Jhosa Tiozen-Corpuz' position='Part-time' index='14' picture={Fac14} description="Jhosa Tiozen-Corpus is currently a Part-Time Instructor of the Fine Arts Department
                                    ...
                                    "/>
                                <FacultyCard name='John Ace C. Hingada' position='Part-time' index='15' picture={Fac15} description=""/>
                                <FacultyCard name='Kevin Ortega' position='Part-time' index='16' picture={Fac16} description=""/>
                                <FacultyCard name='Leticia L. Paldez' position='Part-time' index='17' picture={Fac17} description="Leticia L. Paldez is a multifaceted professional with expertise as an Instructor,
                                    ...
                                    "/>
                                <FacultyCard name='Lorena P. Pacampara' position='Part-time' index='18' picture={Fac18} description="Lorena P. Pacampara’s interest is project development from conceptualization,
                                    ...
                                    "/>
                                <FacultyCard name='Paul M. Alfonso' position='Part-time' index='19' picture={Fac19} description=""/>
                                <FacultyCard name='Rolando Jr. Defeo' position='Part-time' index='20' picture={Fac20} description=""/>
                            </div>
                        </div>
                    </div>
                </div>
